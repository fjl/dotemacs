...
In addition to any hooks its parent mode `web-mode-prog-mode' might have run, this mode
runs the hook `web-mode-hook', as the final or penultimate step during initialization.
