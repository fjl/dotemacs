...
With prefix ARG, enable Global Llama-Fontify mode if ARG is positive; otherwise, disable
it.
...
Llama-Fontify mode is enabled in all buffers where `llama--turn-on-fontify-mode' would do
it.
