...
;;;***

;;;### (autoloads nil "erlang_appwiz" "erlang_appwiz.el" (0 0 0 0))
;;; Generated autoloads from erlang_appwiz.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "erlang_appwiz" '("erlang-" "appwiz-" "my-erlang-load-mods" "fixed-erlang-add-quotes-if-needed")))
