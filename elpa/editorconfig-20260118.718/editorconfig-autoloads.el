...
In addition to any hooks its parent mode `conf-unix-mode' might have run, this mode runs
the hook `editorconfig-conf-mode-hook', as the final or penultimate step during
initialization.
