...
`ein:ipynb-mode-hook', as the final or penultimate step during initialization." t)
...
hook `ein:markdown-mode-hook', as the final or penultimate step during initialization.
