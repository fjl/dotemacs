...
Toggle Dtrt-Indent mode in many buffers.
Specifically, Dtrt-Indent mode is enabled in all buffers where `(lambda nil
...
`dtrt-indent-global-modes' is used to control which modes this minor mode is used in.
