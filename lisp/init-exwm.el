...
(progn
  ...
  (exwm-input-set-key (kbd "<XF86AudioRaiseVolume>")  (fjl/shell-lambda (concat user-emacs-directory "pa-vol.sh plus")))
  (exwm-input-set-key (kbd "<XF86AudioLowerVolume>")  (fjl/shell-lambda (concat user-emacs-directory "pa-vol.sh minus")))
  (exwm-input-set-key (kbd "<XF86AudioMute>")         (fjl/shell-lambda (concat user-emacs-directory "pa-vol.sh mute")))
  ;; Screen Lock
