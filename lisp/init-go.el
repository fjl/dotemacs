...
(defvar gotools-list
  '(("gopls"        "golang.org/x/tools/gopls@v0.6.4")
    ("benchstat"    "golang.org/x/perf/cmd/benchstat")
    ("eg"           "golang.org/x/tools/cmd/eg")
    ("stringer"     "golang.org/x/tools/cmd/stringer")
    ("godef"        "github.com/rogpeppe/godef@v1.1.2")
    ("godoc"        "golang.org/x/tools/cmd/godoc")
    ("gogetdoc"     "github.com/zmb3/gogetdoc")
    ("goimports"    "golang.org/x/tools/cmd/goimports@v0.1.0")
    ("gomvpkg"      "golang.org/x/tools/cmd/gomvpkg@v0.1.0")
    ("gorename"     "golang.org/x/tools/cmd/gorename@v0.1.0")
